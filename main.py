...
im1 = ax1.imshow( scipy.misc.imread(os.path.join("out", "test.jpg")))

filenames = [img for img in glob.glob("out/images/*.jpg")]

filenames.sort() # ADD THIS LINE

images = []
for img in filenames:
    output_image = scipy.misc.imread(img)
    im1.set_data(output_image)
    plt.pause(0.5)

#for filename in glob.glob('out/images/*.jpg'): #assuming gif
#    print(filename)
